package io.github.liaong13.dialogueroute.core.kb
...
object KbSelfCheck {
    ...
    private const val SCRATCH_PREFS = "dialogue_route_kb_selfcheck_scratch"
    ...
    fun run(context: Context): String {
        ...
        try {
            ...
            store.saveContact(Contact(
                ...
                apps = listOf("io.github.liaong13.dialogueroute"),
            ...
            val ctx1 = ContextBuilder.build(context, snapshot, "io.github.liaong13.dialogueroute", prefs)
            ...
            store.appendLog(contactId, listOf(
                LogEntry("other", OLD_LINE, System.currentTimeMillis() - 86_400_000L, "io.github.liaong13.dialogueroute")),
                screenBatch = false)
            val ctx2 = ContextBuilder.build(context, snapshot, "io.github.liaong13.dialogueroute", prefs)
            ...
            if (ContextBuilder.build(context, snapshot, "io.github.liaong13.dialogueroute", prefs).history.isNotEmpty())
