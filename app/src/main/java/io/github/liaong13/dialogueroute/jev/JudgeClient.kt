...
import io.github.liaong13.dialogueroute.core.Choice
import io.github.liaong13.dialogueroute.core.Prefs
import io.github.liaong13.dialogueroute.core.RankedReply
import io.github.liaong13.dialogueroute.core.Score
import io.github.liaong13.dialogueroute.core.kb.ChatContext
...
class JudgeClient(private val prefs: Prefs) {
    ...
    companion object { private const val TAG = "DIALOGUEROUTE" }
}
